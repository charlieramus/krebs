...
| U16 | 53000, was 40000 | `GLYCOLYSIS_ATP_THRESHOLDS[0]` | | Cumulative gross ATP before the first glycolytic rung is buyable | **Derived from a clock.** Target 22 game-minutes, reading 53382, lands at 21m52s | V5 stage 3 as first fit, derived in V5 stage 4 |
| U17 | 93000, was 90000 | `GLYCOLYSIS_ATP_THRESHOLDS[1]` | | Second rung | Target 35 minutes, reading 92737, lands at 35m04s | V5 stage 3, derived in V5 stage 4 |
| U18 | 139000, was 160000 | `GLYCOLYSIS_ATP_THRESHOLDS[2]` | | Third rung | Target 48 minutes, reading 138643, lands at 48m06s | V5 stage 3, derived in V5 stage 4 |
| U19 | 195000, was 250000 | `GLYCOLYSIS_ATP_THRESHOLDS[3]` | | Fourth and last rung | Target 62 minutes, reading 195240, lands at 61m57s. **The four together hold the gap between events at 13m02s to 13m51s**, against 11m03s growing to 22m16s under the first-fit values. The longest wait is what NOW.md blocking item 2 is about, and an even distribution is worth more than a last event nearer 90 minutes | V5 stage 3, derived in V5 stage 4 |
