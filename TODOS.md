...
**Why:** UPDATELOGV9.md's stage list covers CI, cross-engine determinism, deployment and a CLAUDE.md correction, and has no stage that verifies the deployed thing. All six build-failing guards run before the bundle exists. None of them looks at the page on the domain.
